    ...
    <form action="ingresar_hardware.php" method="POST" class="mb-4">
        ...
        <div class="mb-3">
            ...
            <select name="tipo_hardware" id="tipo_hardware" class="form-select" required onchange="mostrarCamposHardware()">
                ...
                <option value="slots_memoria_placa">Slots Memoria Placa</option>
        ...
        <!-- Campos para slots_memoria_placa (Ocultos inicialmente) -->
        <div class="mb-3" id="camposSlots_memoria_placa" style="display: none;">
            <label for="slots_memoria_placa" class="form-label">Slots Memoria Placa</label>
            <input type="text" name="slots_memoria_placa" class="form-control" id="slots_memoria_placa">
        </div>
...
<script>
    function mostrarCamposHardware() {
        ...
        document.getElementById("camposSlots_memoria_placa").style.display = "none";
        ...
        else if (tipoHardware === "slots_memoria_placa") {
            document.getElementById("camposSlots_memoria_placa").style.display = "block";
        } 
