...
<nav aria-label="breadcrumb" class="mb-4">
    ...
    <div class="container my-5 bg-white p-4 shadow-sm rounded">
        ...
        <p>
            Somos <strong>Tisnology Concepción</strong>, una empresa comprometida con brindar productos y servicios de alta calidad 
            a nuestros clientes en Concepción y sus alrededores. Nuestra misión es ofrecer soluciones innovadoras que mejoren la vida 
            de nuestros clientes y generen un impacto positivo en nuestra comunidad.
        </p>

        <h2 class="mt-4">Nuestra Misión</h2>
        <p>
            En Tisnology Concepción, trabajamos incansablemente para ofrecer productos de alta calidad y un servicio al cliente excepcional.
            Creemos en la importancia de construir relaciones sólidas con nuestros clientes y en ser una empresa confiable y ética.
        </p>

        <h2 class="mt-4">Nuestros Valores</h2>
        <ul class="list-group my-3">
            <li class="list-group-item"><strong>Innovación:</strong> Siempre buscamos mejorar y ofrecer lo mejor a nuestros clientes.</li>
            <li class="list-group-item"><strong>Calidad:</strong> Garantizamos que nuestros productos y servicios cumplan con los más altos estándares.</li>
            <li class="list-group-item"><strong>Confianza:</strong> Construimos relaciones sólidas basadas en la transparencia y el respeto mutuo.</li>
            <li class="list-group-item"><strong>Responsabilidad:</strong> Estamos comprometidos con nuestra comunidad y el medio ambiente.</li>
        </ul>
