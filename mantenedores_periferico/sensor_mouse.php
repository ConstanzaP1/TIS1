...
<div class="container mt-5">
    ...
    <form action="ingresar_periferico.php" method="POST" id="formulario" style="display: none;" class="mt-4">
        <h1 class="mb-4">Ingreso Sensor</h1>
        <!-- Campo oculto para seleccionar automaticamente -->
        <input type="hidden" name="tipo_periferico" value="sensor_mouse">

        <div class="mb-3">       
            <label for="sensor_mouse" class="form-label mt-3">Sensor Mouse</label>
            <input type="text" name="sensor_mouse" class="form-control" id="sensor_mouse" required>
        </div>
