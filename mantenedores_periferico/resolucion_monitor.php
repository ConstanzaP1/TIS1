...
<div class="container mt-5">
    ...
    <form action="ingresar_periferico.php" method="POST" id="formulario" style="display: none;" class="mt-4">
        ...
        <div class="mb-3">       
            <label for="resolucion_monitor" class="form-label mt-3">Resolución Monitor</label>
            <input type="text" name="resolucion_monitor" class="form-control" id="resolucion_monitor" required>
        </div>

        <!-- Contenedor para alinear los botones -->
        <div class="d-flex justify-content-between mt-3">
            <!-- Botón de guardar -->
            <button type="submit" class="btn btn-success">Guardar Resolución Monitor</button>
