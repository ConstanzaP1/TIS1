...
<div class="container mt-5">
    ...
    <form action="ingresar_periferico.php" method="POST" id="formulario" style="display: none;" class="mt-4">
        <h1 class="mb-4">Ingreso tiempo de respuesta</h1>
        <!-- Campo oculto para seleccionar automaticamente -->
        <input type="hidden" name="tipo_periferico" value="tiempo_respuesta">

        <div class="mb-3">       
            <label for="tiempo_respuesta" class="form-label mt-3">Tiempo de Respuesta</label>
            <input type="text" name="tiempo_respuesta" class="form-control" id="tiempo_respuesta" required>
        </div>
