...
<div class="container mt-5">
    ...
    <button type="button" id="botonAgregar" class="btn btn-primary" onclick="mostrarFormulario()">Agregar Gpu Notebook</button>
    ...
    <form action="ingresar_notebook.php" method="POST" id="formulario" style="display: none;" class="mt-4">
        ...
        <div class="d-flex justify-content-between mt-3">
            <!-- Botón de guardar -->
            <button type="submit" class="btn btn-success">Guardar Gpu notebook</button>
