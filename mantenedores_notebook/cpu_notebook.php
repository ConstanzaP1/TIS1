...
<div class="container mt-5">
    ...
    <button type="button" id="botonAgregar" class="btn btn-primary" onclick="mostrarFormulario()">Agregar Cpu Notebook</button>
    ...
    <form action="ingresar_notebook.php" method="POST" id="formulario" style="display: none;" class="mt-4">
        ...
        <div class="d-flex justify-content-between mt-3">
            <!-- Botón de guardar -->
            <button type="submit" class="btn btn-success">Guardar Cpu notebook</button>
