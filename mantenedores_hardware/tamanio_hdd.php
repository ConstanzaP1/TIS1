...
// Consulta para obtener datos de la tabla tamanio_hdd que no sean NULL
$query = "
    SELECT p.id_hardware, 
           tf.tamanio_hdd
    FROM hardware p
    LEFT JOIN tamanio_hdd tf ON p.id_hardware = tf.id_hardware
    WHERE tf.tamanio_hdd IS NOT NULL
";
...
<div class="container mt-5">
                ...
                <table class="table table-bordered mt-4">
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                            <tr>
                                <td><?php echo $row['tamanio_hdd']; ?></td>
                                <td>
    ...
    <form action="ingresar_hardware.php" method="POST" id="formulario" style="display: none;" class="mt-4">
        ...
        <div class="mb-3">
            <label for="tamanio_hdd" class="form-label">Tamaño hdd</label>
