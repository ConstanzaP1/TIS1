...
// Consulta ajustada para seleccionar datos de la tabla `tamanio_hdd`
$query = "
    SELECT p.id_hardware, th.tamanio
    FROM hardware p
    LEFT JOIN tamanio_hdd th ON p.id_hardware = th.id_hardware
    WHERE th.tamanio IS NOT NULL
";
...
<head>
    ...
    <title>Ingreso de Mantenedores Tamaño Disco</title>
    <!-- Bootstrap CSS -->
