...
// Consulta ajustada para seleccionar datos de la tabla `formato_ssd`
$query = "
    SELECT p.id_hardware, fs.formato
    FROM hardware p
    LEFT JOIN formato_ssd fs ON p.id_hardware = fs.id_hardware
    WHERE fs.formato IS NOT NULL
";
...
<head>
    ...
    <title>Ingreso de Mantenedores - FORMATO</title>
    <!-- Bootstrap CSS -->
...
<div class="container mt-5">
    ...
    <form action="ingresar_hardware.php" method="POST" id="formulario" style="display: none;" class="mt-4">
        ...
        <input type="hidden" name="tipo_hardware" value="formato" />

        <div class="mb-3">
            <label for="formato" class="form-label">Formato</label>
            <input type="text" name="formato" class="form-control" id="formato" required>
        </div>
