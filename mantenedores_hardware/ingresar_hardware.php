...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conexion, $queryHardware)) {
        ...
        }         // Insertar en la tabla chipset_gpu
        elseif ($tipo_hardware == 'chipset_gpu') {
            ...
            if (mysqli_query($conexion, $queryChipset_gpu)) {
                echo "Ingreso de chipset GPU exitoso.<br>";
            } else {
                echo "Error al insertar chipset GPU: " . mysqli_error($conexion);
            }
        ...
        elseif ($tipo_hardware == 'bus_hdd') {
            ...
            if (mysqli_query($conexion, $queryBusHDD)) {
                echo "Ingreso de bus HDD exitoso.<br>";
            } else {
                echo "Error al insertar bus HDD: " . mysqli_error($conexion);
            }
        ...
        // Insertar en la tabla bus_ssd
        elseif ($tipo_hardware == 'bus_ssd') {
            $bus_ssd = $_POST['bus_ssd'];
            $queryBus_ssd = "INSERT INTO bus_ssd (id_hardware, bus) VALUES ('$id_hardware', '$bus_ssd')";
        ...
        // Insertar en la tabla formato_ssd
        elseif ($tipo_hardware == 'formato_ssd') {
            $formato_ssd = $_POST['formato_ssd'];
            $queryFormato_ssd = "INSERT INTO formato_ssd (id_hardware, formato) VALUES ('$id_hardware', '$formato_ssd')";
        ...
        // Insertar en la tabla rpm_hdd
        elseif ($tipo_hardware == 'rpm_hdd') {
            $rpm_hdd = $_POST['rpm_hdd'];
            $queryRpm_hdd = "INSERT INTO rpm_hdd (id_hardware, rpm) VALUES ('$id_hardware', '$rpm_hdd')";
        ...
        // Insertar en la tabla tamanio_hdd
        elseif ($tipo_hardware == 'tamanio_hdd') {
            $tamanio_hdd = $_POST['tamanio_hdd'];
            $queryTamanio_hdd = "INSERT INTO tamanio_hdd (id_hardware, tamanio) VALUES ('$id_hardware', '$tamanio_hdd')";
        ...
        // Insertar en la tabla bus_de_entrada_gpu
        elseif ($tipo_hardware == 'bus_de_entrada_gpu') {
            ...
            if (mysqli_query($conexion, $qbus_de_entrada_gpu)) {
                echo "Ingreso exitoso.";
            } else {
                echo "Error al insertar." . mysqli_error($conexion);
            }
