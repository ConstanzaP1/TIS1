...
// Consulta para obtener datos de la tabla bus_hdd que no sean NULL
$query = "
    SELECT p.id_hardware, 
           bh.bus_hdd
    FROM hardware p
    LEFT JOIN bus_hdd bh ON p.id_hardware = bh.id_hardware
    WHERE bh.bus_hdd IS NOT NULL
";
...
<div class="container mt-5">
    ...
    <form action="ingresar_hardware.php" method="POST" id="formulario" style="display: none;" class="mt-4">
        ...
        <div class="mb-3">
            <label for="bus_hdd" class="form-label">Bus Hdd</label>
