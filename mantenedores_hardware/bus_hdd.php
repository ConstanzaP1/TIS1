...
// Suponiendo que tu consulta selecciona datos de la tabla `bus_hdd`
$query = "
    SELECT p.id_hardware, bh.bus
    FROM hardware p
    LEFT JOIN bus_hdd bh ON p.id_hardware = bh.id_hardware
    WHERE bh.bus IS NOT NULL
";
...
<head>
    ...
    <title>Ingreso de Mantenedores - BUS</title>
    <!-- Bootstrap CSS -->
