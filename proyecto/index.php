...
<div class="container mt-5">
    ...
    <h2 class="mb-4">Perifericos Registrados</h2>
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                <tr>
                    ...
                    <td>
                        <a href="modificar_perifericos.php?id_periferico=<?php echo $row['id_periferico']; ?>">Modificar</a> | 
                        <a href="eliminar_perisfericos.php?id_periferico=<?php echo $row['id_periferico']; ?>">Eliminar</a>
