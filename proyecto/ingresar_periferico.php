...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conexion, $queryPeriferico)) {
        ...
        if ($tipo_periferico == 'conectividad') {
            ...
            header('location: admin_panel_mouse.php');
            ...
            header('location: admin_panel_teclado.php');
            ...
            header('location: admin_panel_periferico.php');
            ...
            header('location: admin_panel_monitor.php');
